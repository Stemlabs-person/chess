...
const PUZZLES = [
  ...
  { d: "easy", title: "Sneaky Check", desc: "Black to move. Capture the center pawn and give check — it's completely safe!", fen: "rnb1kbnr/pppp1ppp/8/4p3/4P2q/5N2/PPPP1PPP/RNBQKB1R b KQkq - 2 3", solution: ["Qxe4+"] },
  ...
  { d: "easy", title: "Queen Check", desc: "White to move. Move the queen up the file so it checks the king safely!", fen: "4k3/8/8/8/8/8/8/3QK3 w - - 0 1", solution: ["Qe2+"] },
  ...
  { d: "hard", title: "Queen Snipe", desc: "White to move. Capture the knight with check — completely safe from recapture!", fen: "4k3/8/2n5/8/8/8/8/4K2Q w - - 0 1", solution: ["Qxc6+"] },
...
const LESSONS = [
  ...
  },
  {
    ...
    fen: "7k/8/8/3B4/8/8/8/4K3 w - - 0 1",
  },
  {
    icon: "♖",
    title: "The Rook",
